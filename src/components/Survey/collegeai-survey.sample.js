...
export const questionList = [
  ...
  {
    title: "What was your math SAT score?",
    name: "sat-score:math",
    visibleIf: "{var('tests-taken')} contains 'sat-main'",
    type: "slider",
    min: 0,
    max: 800,
    step: 10
  ...
  {
    title: "What was your reading SAT score?",
    name: "sat-score:reading",
    visibleIf: "{var('tests-taken')} contains 'sat-main'",
    type: "slider",
    min: 0,
    max: 800,
  ...
  {
    title: "What was your reading ACT score?",
    name: "act-score:reading",
    visibleIf: "{var('tests-taken')} contains 'act'",
    type: "slider",
    min: 0,
    max: 36,
    step: 1
  ...
  {
    title: "What was your science ACT score?",
  ...
  {
    title: "What was your math ACT score?",
    name: "act-score:math",
    visibleIf: "{var('tests-taken')} contains 'act'",
    type: "slider",
    min: 0,
  ...
  {
    title: "What was your english ACT score?",
...
export default questionList.reduce((acc, q) => {
  acc[q.name] = q
  return acc
}, {})
